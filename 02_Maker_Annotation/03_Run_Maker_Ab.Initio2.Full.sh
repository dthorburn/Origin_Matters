#!/bin/bash
#$ -N X03_mkRdIIc_Test
#$ -o /data/scratch/btx316/Comp_Genomics/22_Maker_Annotation/03_Full_Run_8Core
#$ -pe smp 8
#$ -cwd
#$ -j y
#$ -l h_vmem=12G
...
OUTDIR=/data/scratch/btx316/Comp_Genomics/22_Maker_Annotation/03_Full_Run_8Core
