#!/bin/sh
#$ -N Chromosemble_Satsuma2_Peichel_Resolved_FINALLY_NM
#$ -j Y
#$ -cwd
#$ -t 1
#$ -l node_type=nxv
...
OUT_DIR=/data/scratch/btx316/Comp_Genomics/08_Satsuma2/00_Chromosembl_Peichel_Resolved_Misassembled_NM_TH
...
mkdir $OUT_DIR
cd $OUT_DIR
$Tool/Chromosemble -n 10 -nomerge 1 -thorough 1 -q $Ref_Gynogene/Contigs_to_assemble.fasta -t $Ref_Peichel/Gac-HiC_revised_genome_assembly_UninContigs.fasta -o $OUT_DIR/
#-nomerge 1
echo "Done"
date