...
SCRIPT=/data/SBCS-EizaguirreLab/Miles/CompGenomics_Collab/01_Scripts/06_Picard_PreCall/Gynogene
DATA_DIR=/data/scratch/btx316/Comp_Genomics/02_Mapped/Gynogene/bam_files
...
query_file=`sed ${SGE_TASK_ID}"q;d" $SCRIPT/01_File_List_Gynogene.txt`
echo $query_file
