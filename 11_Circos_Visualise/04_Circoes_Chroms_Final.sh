...
if [ $SGE_TASK_ID = 22 ] ; then contig_num="chrI_chrIV"; echo "$contig_num Changed from chrI_chrIV" ; fi
...
mv /data/home/btx316/privatemodules/circos-0.69-9/circos_"$contig_num"_0.95_1kb_rev.png $OUT_DIR/Plots/
